...
class Observation:
    ...
    def to_features(self, feature_name: str):
        assert feature_name in ("mjx-small-v0", "han22-v0", "mjx-large-v0", "decision-mamba-v0")
        assert self._cpp_obj is not None
        ...
        if feature_name == "decision-mamba-v0":
            feature = np.array(self._cpp_obj.to_features_1d(feature_name), dtype=np.float32)  # type: ignore
            return feature
